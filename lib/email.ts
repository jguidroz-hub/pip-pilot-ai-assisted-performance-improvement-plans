...
const FROM = process.env.EMAIL_FROM || 'PIP Pilot - AI-Assisted Performance Improvement Plans <noreply@example.com>';
const APP_NAME = 'PIP Pilot - AI-Assisted Performance Improvement Plans';

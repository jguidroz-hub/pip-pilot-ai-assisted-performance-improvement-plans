...
export default function FeaturePage() {
  const items = [
    { t: "Engineering — Sprint 14", d: "Velocity: 42 pts • Completion: 85% • Blockers: 2 • On track", s: "good" },
    { t: "Design — Q1 Goals", d: "Progress: 60% • Shipped: 8 features • In review: 3", s: "good" },
    { t: "New Hires — Onboarding", d: "3 people in progress • Avg completion: 72% • Target: 2 weeks", s: "neutral" },
    { t: "PTO This Week", d: "2 team members out • Coverage arranged • No impact", s: "info" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Performance tracking and milestones</p>

...
export default function PerformanceImprovements/[id]Page() {
  ...
  useEffect(() => {
    fetch('/api/performance-improvements/[id]')
      .then(r => r.json())
  ...
  const handleCreate = async () => {
    ...
    const res = await fetch('/api/performance-improvements/[id]', {
      method: 'POST',
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">PIP Details</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Detailed view of individual PIP</p>

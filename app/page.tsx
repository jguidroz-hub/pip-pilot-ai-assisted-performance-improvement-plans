  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">PIP Pilot - AI-Assisted Performance Improvement Plans</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Streamlines and automates the Performance Improvement Plan (PIP) process for managers, providing data-driven insights, customizable templates, and progress tracking to reduce burnout and improve outcomes for underperforming employees.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust PIP Pilot - AI-Assisted Performance Improvement Plans.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} PIP Pilot - AI-Assisted Performance Improvement Plans. All rights reserved.</p>
